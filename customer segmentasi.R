library(ggplot2)
pelanggan <- read.csv("https://storage.googleapis.com/dqlab-dataset/customer_segments.txt", sep="\t")				#membaca dataset
pelanggan #menampilkan dataset
...
#Bagian K-Means
set.seed(100)
kmeans(x=pelanggan[c("Umur","Profesi.1")], centers=5)
